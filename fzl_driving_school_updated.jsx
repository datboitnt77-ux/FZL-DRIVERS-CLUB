...
// public/images/
//
// public/images/truck-front.png
// public/images/car-front.png
// public/images/car-side.png

export default function App() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white text-gray-800 font-serif scroll-smooth">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/images/car-side.png')",
      ...
      >
        ...
        <div className="relative z-10 px-6 max-w-4xl">
          ...
          <a
            href="tel:0835326609"
            className="bg-white text-blue-900 px-10 py-4 rounded-xl font-semibold shadow-xl hover:scale-105 transition"
          >
            Book Now
          </a>
        </div>
      ...
      <section id="vehicles" className="py-32 bg-white text-center">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto px-6">
          <img src="/images/truck-front.png" alt="Truck" className="rounded-3xl shadow-2xl w-full" />
          <img src="/images/car-front.png" alt="Car Front" className="rounded-3xl shadow-2xl w-full" />
          <img src="/images/car-side.png" alt="Car Side" className="rounded-3xl shadow-2xl w-full" />
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div className="bg-white p-12 rounded-3xl shadow-2xl">
              ...
              <a
                href="tel:0835326609"
                className="inline-block mt-8 bg-blue-800 text-white px-8 py-3 rounded-xl hover:bg-blue-900 transition"
              >
                Book Now
              </a>
            </div>
      ...
      <a
        href="https://wa.me/27835326609"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white p-5 rounded-full shadow-2xl text-2xl z-50 transition"
      >
        💬
      </a>
